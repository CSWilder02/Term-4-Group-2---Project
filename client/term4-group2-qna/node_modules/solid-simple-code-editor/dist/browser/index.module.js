import { isServer, delegateEvents, spread, mergeProps as mergeProps$1, addEventListener, setAttribute, effect, className, style, template, use } from 'solid-js/web';
...
const _tmpl$ = /*#__PURE__*/template(`<div><textarea autocapitalize="off" autocomplete="off"></textarea><pre aria-hidden="true"></pre><style>`);
const Editor = props => {
  ...
  return (() => {
    ...
    addEventListener(_el$2, "keyup", local.onKeyUp, true);
    _el$2.$$keydown = handleKeyDown;
    addEventListener(_el$2, "focus", local.onFocus);
    addEventListener(_el$2, "click", local.onClick, true);
    _el$2.$$input = handleChange;
    addEventListener(_el$2, "blur", local.onBlur);
    const _ref$ = textareaElement;
    typeof _ref$ === "function" ? use(_ref$, _el$2) : textareaElement = _el$2;
    setAttribute(_el$2, "data-gramm", false);
    ...
    effect(_p$ => {
      ...
      _v$4 !== _p$._v$4 && setAttribute(_el$2, "form", _p$._v$4 = _v$4);
      _v$5 !== _p$._v$5 && setAttribute(_el$2, "id", _p$._v$5 = _v$5);
      _v$6 !== _p$._v$6 && setAttribute(_el$2, "maxlength", _p$._v$6 = _v$6);
      _v$7 !== _p$._v$7 && setAttribute(_el$2, "minlength", _p$._v$7 = _v$7);
      _v$8 !== _p$._v$8 && setAttribute(_el$2, "name", _p$._v$8 = _v$8);
      _v$9 !== _p$._v$9 && setAttribute(_el$2, "placeholder", _p$._v$9 = _v$9);
      _v$10 !== _p$._v$10 && (_el$2.readOnly = _p$._v$10 = _v$10);
      _v$11 !== _p$._v$11 && (_el$2.required = _p$._v$11 = _v$11);
      _p$._v$12 = style(_el$2, _v$12, _p$._v$12);
      return _p$;
    }, {
      _v$: undefined,
      _v$2: undefined,
    ...
    effect(() => _el$2.value = local.value);
    return _el$;
  })();
};
delegateEvents(["input", "click", "keydown", "keyup"]);
